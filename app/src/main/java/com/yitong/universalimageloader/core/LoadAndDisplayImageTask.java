...
import com.yitong.universalimageloader.core.assist.FailReason.FailType;
...
import com.yitong.universalimageloader.core.decode.ImageDecodingInfo;
import com.yitong.universalimageloader.core.download.ImageDownloader;
import com.yitong.universalimageloader.core.download.ImageDownloader.Scheme;
 ...
 * display it in {@link com.yitong.universalimageloader.core.imageaware.ImageAware} using {@link DisplayBitmapTask}.
 *
    ...
    private boolean waitIfPaused() {
        ...
        if (pause.get()) {
            synchronized (engine.getPauseLock()) {
                //ICO fix 使用if可能表达式结果未改变而被唤醒导致逻辑错误
                while (pause.get()) {
