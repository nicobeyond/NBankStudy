 ...
 *******************************************************************************/
package com.yitong.universalimageloader.core.decode;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.yitong.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
