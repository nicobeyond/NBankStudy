...
import static android.support.v4.view.ViewPager.DecorView;
import static android.support.v4.view.ViewPager.OnAdapterChangeListener;
 ...
 * done through {@link Tab} instances. You create tabs via {@link #newTabs()}. From there you can
 ...
 * <pre>
 * TabLayout tabLayout = ...;
 * tabLayout.addTab(tabLayout.newTabs().setText("Tab 1"));
 * tabLayout.addTab(tabLayout.newTabs().setText("Tab 2"));
 * tabLayout.addTab(tabLayout.newTabs().setText("Tab 3"));
 * </pre>
...
public class BaseTabLayouts extends HorizontalScrollView {
    ...
    private static final int ANIMATION_DURATION = 300;//TODO 设置tab切换动画的持续时间,默认是300
    ...
    //TODO 设置下划线的左右内边距,以此来控制下划线的宽度
    protected int tabIndicatorOffsetLeft = 0, tabIndicatorOffsetRight = 0;
...
//        ThemeUtils.checkAppCompatTheme(context);
     ...
     */
    @Nullable
    public Tab getTabsAt(int index) {
    ...
    void populateFromPagerAdapter() {
        ...
        if (mPagerAdapter != null) {
            ...
            for (int i = 0; i < adapterCount; i++) {
                addTab(newTabs().setText(mPagerAdapter.getPageTitle(i)), false);
            }
    ...
    /**
     * A tab in this layout. Instances can be created via {@link #newTabs()}.
     */
     ...
     * {@link ViewPager#addOnPageChangeListener(OnPageChangeListener)
        ...
        public void onPageSelected(final int position) {
            ...
            if (myTabLayout != null && myTabLayout.getSelectedTabPosition() != position
                ...
                final boolean updateIndicator = mScrollState == SCROLL_STATE_IDLE
                        ...
                        && mPreviousScrollState == SCROLL_STATE_IDLE);
                myTabLayout.selectTab(myTabLayout.getTabsAt(position), updateIndicator);
            }
        }
    ...
    public class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            //TODO
            final int targetLeft = targetView.getLeft() + tabIndicatorOffsetLeft;
            final int targetRight = targetView.getRight() - tabIndicatorOffsetRight;
            final int startLeft;
